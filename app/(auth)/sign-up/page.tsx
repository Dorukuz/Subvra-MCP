  ...
  return (
    <div className="w-full max-w-[400px]">
      <div className="rounded-3xl border border-hairline bg-surface-1 p-8 shadow-[var(--shadow-md)]">
        <div className="mb-2 inline-flex items-center gap-2 rounded-full border border-accent-300/60 bg-accent-50 px-2.5 py-1 font-mono text-[10px] uppercase tracking-[0.18em] text-accent-700 dark:border-accent-700/50 dark:bg-accent-700/10 dark:text-accent-300">
        ...
        <p className="mt-1.5 text-[13px] text-slate-500">
          Start generating App Store screenshots in under a minute.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="h-11 w-full rounded-xl border border-hairline bg-surface-1 px-3.5 text-sm text-foreground transition-[border-color] duration-200 placeholder:text-slate-400 hover:border-slate-300 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20 dark:hover:border-slate-600"
            />
            <p className="text-[11px] text-slate-500">8+ characters</p>
          </div>
          <button
            type="submit"
            disabled={loading}
        ...
        <p className="mt-5 text-center text-[11px] leading-relaxed text-slate-500">
          ...
          <Link href="/terms" className="text-primary-700 hover:underline dark:text-primary-400">
            Terms
          </Link>{" "}
          and{" "}
          <Link href="/privacy" className="text-primary-700 hover:underline dark:text-primary-400">
            Privacy Policy
          </Link>
          .
        </p>
